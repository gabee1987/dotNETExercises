...
{
    internal class MergeWithSorting_Solution_2_Tests
    {
        ...
        public void MergeWithSorting_AllElementsPresentInResult()
        {
            ...
            // Act
            var result = firstIntArray.MergeWithSorting_Solution_2( secondIntArray, Comparer<int>.Default );
        ...
        public void MergeWithSorting_StringsAscendingOrder_ReturnsSortedCollection()
        {
            ...
            // Act
            var result = firstStringArray.MergeWithSorting_Solution_2( secondStringArray, Comparer<string>.Default );
        ...
        public void MergeWithSorting_EmptyFirsCollection_Returns_SecondCollectionSorted()
        {
            ...
            // Act
            var result = firstArr.MergeWithSorting_Solution_2( secondIntArray, Comparer<int>.Default );
        ...
        public void MergeWithSorting_EmptyCollections_Returns_EmptyCollection()
        {
            ...
            // Act
            var result = firstArr.MergeWithSorting_Solution_2( secondArr, Comparer<int>.Default );
        ...
        public void MergeWithSorting_DifferentCollectionTypes_ReturnsSortedCollection()
        {
            ...
            //Act
            var result = firstIntList.MergeWithSorting_Solution_2( secondIntArray, Comparer<int>.Default );
        ...
        public void MergeWithSorting_FirstCollectionIsNull_ThrowsException()
        {
            ...
            //Act
            Action act = () => firstIntList.MergeWithSorting_Solution_2( secondIntArray, Comparer<int>.Default );
        ...
        public void MergeWithSorting_SecondCollectionIsNull_ThrowsException()
        {
            ...
            //Act
            Action act = () => firstIntArray.MergeWithSorting_Solution_2( secondIntList, Comparer<int>.Default );
