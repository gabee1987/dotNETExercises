namespace TestProject
{
    internal class MergeWithSorting_Solution_3_Tests
    {
        ...
        public void MergeWithSorting_AllElementsPresentInResult()
        {
            ...
            // Act
            var result = firstIntArray.MergeWithSorting_Solution_3( secondIntArray, (x, y ) => x.CompareTo( y ) );
        ...
        public void MergeWithSorting_IntsDescendingOrder_ReturnsSortedCollection()
        {
            ...
            // Act
            var result = firstIntArray.MergeWithSorting_Solution_3( secondIntArray, ( x, y ) => y.CompareTo( x ) );
        ...
        public void MergeWithSorting_StringsAscendingOrder_ReturnsSortedCollection()
        {
            ...
            // Act
            var result = firstStringArray.MergeWithSorting_Solution_3( secondStringArray, ( x, y ) => x.CompareTo( y ) );
        ...
        public void MergeWithSorting_StringsDescendingOrder_ReturnsSortedCollection()
        {
            ...
            // Act
            var result = firstStringArray.MergeWithSorting_Solution_3( secondStringArray, ( x, y ) => y.CompareTo( x ) );
        ...
        public void MergeWithSorting_EmptyFirsCollection_Returns_SecondCollectionSorted()
        {
            ...
            // Act
            var result = firstArr.MergeWithSorting_Solution_3( secondIntArray, ( x, y ) => x.CompareTo( y ) );
        ...
        public void MergeWithSorting_EmptyCollections_Returns_EmptyCollection()
        {
            ...
            // Act
            var result = firstArr.MergeWithSorting_Solution_3( secondArr, ( x, y ) => x.CompareTo( y ) );
        ...
        public void MergeWithSorting_DifferentCollectionTypes_ReturnsSortedCollection()
        {
            ...
            //Act
            var result = firstIntList.MergeWithSorting_Solution_3( secondIntArray, ( x, y ) => x.CompareTo( y ) );
        ...
        public void MergeWithSorting_FirstCollectionIsNull_ThrowsException()
        {
            ...
            //Act
            Action act = () => firstIntList.MergeWithSorting_Solution_3( secondIntArray, ( x, y ) => x.CompareTo( y ) );
        ...
        public void MergeWithSorting_SecondCollectionIsNull_ThrowsException()
        {
            ...
            //Act
            Action act = () => firstIntArray.MergeWithSorting_Solution_3( secondIntList, ( x, y ) => x.CompareTo( y ) );
